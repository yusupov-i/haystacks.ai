    ...
    content: (
      <span>
        ...
        <p>
          ...
          Haystacks, AI, Inc. ("Company", “we”, “us”, or “our”), concerning your
          access to and use of the haystacks.ai website as well as any other
        ...
        <p>
          ...
          for violations of these <a href="/terms">Terms of Use</a>; (2) take
        ...
        <p>
          <b>Binding Arbitration:</b> If the Parties are unable to resolve a
          ...
          rules or applicable law, the arbitration will take place inUnited
          States of America, New York. Except as otherwise provided herein, the
        ...
        <p>
          ...
          and federal courts located in the United States of America, New York,
        ...
        <p>
          <b>Restrictions:</b> The Parties agree that any arbitration shall be
        ...
        <p>
          <b>Exceptions to Arbitration:</b> The Parties agree that the following
        ...
        <address style={{ fontStyle: 'normal' }}>
          <p style={{ marginBottom: 0 }}>Haystacks, AI, Inc.</p>
          <p style={{ marginBottom: 0 }}>1123 Broadway</p>
          <p style={{ marginBottom: 0 }}>Suite 601</p>
          <p style={{ marginBottom: 0 }}>New York, NY10010</p>
          <p style={{ marginBottom: 0 }}>United States</p>
        </address>
        <p style={{ marginBottom: 0 }}>
          <a href="mailto:hello@haystacks.ai">hello@haystacks.ai</a>
        </p>
      </span>
    )
  }
